...
Before running the project, open Kaggle settings: https://www.kaggle.com/settings/api

Create a Legacy API Key once and place the downloaded `kaggle.json` file in the project directory before running the commands below.
...
Below is an example prediction plot generated by the app when running inference on `test.csv`.
